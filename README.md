...
Registration Number: 24BCE10095
...
A detailed 11 page report
5 Linux shell scripts
A structured analysis of one open-source software
...
Checks if selected software is installed and displays:
Version
License
Summary
Also prints a short philosophy note.
Concepts used:
if-else
case statement
rpm / dpkg commands
...
Count keyword occurrences (default: "error")
Provide summary
Concepts used:
while read loop
...
Exploring real-world software ecosystems
